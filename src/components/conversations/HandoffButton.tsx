    ...
    return (
      <div className="flex flex-col gap-1">
        ...
        >
          ...
          გადაცემულია ოპერატორზე
          {handedOffAt && (
            <span className="text-[10px] text-emerald-400/80">
              · {new Date(handedOffAt).toLocaleString('ka-GE', { hour: '2-digit', minute: '2-digit', day: 'numeric', month: 'short' })}
            </span>
          )}
        </button>
        <button
    ...
    return (
      <div className="flex flex-col gap-2 p-3 rounded-lg bg-amber-500/[0.06] border border-amber-500/20">
        <p className="text-[11px] text-amber-200 leading-relaxed">
          ბოტი შეწყვეტს ავტო-პასუხებს ამ საუბრისთვის — customer-მა იცის რომ ცოცხალი ადამიანი უპასუხებს.
        </p>
