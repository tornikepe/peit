...
// Sign-in form body — rendered inside the homepage AuthModal. Headless Clerk
// v7 flow (signIn.password → finalize); zero Clerk UI.
...
export default function SignInForm({ onSwitch, onDone }: { onSwitch: () => void; onDone: () => void }) {
  ...
  return (
    <>
      <h2 className="text-2xl font-bold text-white tracking-tight">{en ? 'Welcome back' : 'კარგია, რომ დაბრუნდი'}</h2>
      <p className="text-sm text-gray-400 mt-1.5 mb-6 leading-relaxed">{en ? 'Sign in to manage your AI agents.' : 'შედი და მართე შენი AI აგენტები.'}</p>
